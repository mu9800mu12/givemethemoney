...
<jsp:include page="/WEB-INF/view/templates/sidebar.jsp"></jsp:include>
 ...
 <script type="text/javascript">
 	function doAdd(member_no){
 		location.href="/master/addLeader.do?member_no="+member_no;
 	}
 	function doDelete(member_no){
 		location.href="/master/deleteLeader.do?member_no="+member_no;
 	}
 </script>
        <!--**********************************
            Content body start
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=mDTO.getMember_approve() %></td>
                                                <td><a href="javascript:doAdd('<%=Integer.toString(mDTO.getMember_no()) %>');">리더추가</a></td>
                                                <td><a href="javascript:doDelete('<%=Integer.toString(mDTO.getMember_no()) %>');">리더삭제</a></td>
                                            </tr>
                                        	<%
                                        		}
                                        	%>
