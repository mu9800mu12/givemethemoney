                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="member_name" value="${memberinfo.member_name}" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-confirm-password" name="member_phone"value="${memberinfo.member_phone}" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-website" name="addr1" value="${memberinfo.member_addr1}"readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phoneus" name="addr2" value="${memberinfo.member_addr2}"readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="button" onclick="location.href='${pageContext.request.contextPath}/user/checkPassword.do'" class="btn btn-primary">회원정보 수정 및 탈퇴</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
