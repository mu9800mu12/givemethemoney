...
char ssid[] = "GONGBUIN 2";            // your network SSID (name)
char pass[] = "a1234567890!";  


//char ssid[] = "SK_WiFiC99E";            // your network SSID (name)
//char pass[] = "1310016139";        // your network password
int status = WL_IDLE_STATUS;     // the Wifi radio's status

//char timeServer[] = "time.nist.gov";  // old NTP server
char timeServer[] = "ntp.postech.ac.kr";  // postech NTP server
...
void loop()
{
  ...
  if (Udp.parsePacket()) {
    ...
    /*time fix 시간 차이가 발생, 3시간 오차*/
    unsigned long fix = 10800;
    
    unsigned long epoch = secsSince1900 - seventyYears - fix; 
    // print Unix time:
